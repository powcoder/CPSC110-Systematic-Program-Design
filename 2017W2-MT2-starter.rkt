...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname CPSC110-2017W2-MT2-starter) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
(require spd/tags)
