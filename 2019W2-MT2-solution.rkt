...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname 2019W2-MT2-solution) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
(require spd/tags)
